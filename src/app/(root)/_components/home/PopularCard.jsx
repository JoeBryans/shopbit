...
const PopularCard = async () => {
  ...
  return (
    <div>
      <div className='text-gray-900 flex flex-col gap-10 items-center '>
        {/* deals of the day */}
        ...
        {/* latest products */}
        <div className='max-w-full w-max bg-white rounded-2xl pt-2 '> <h1 className='ml-4 text-lg font-semibold md:ml-10 '>Latest Products from Popular Brands</h1>
